...
<head>
    ...
    <title>Police Accountability Report - GB Police</title>
...
<body>
    <!-- Header Section -->
    <header class="integrity-theme py-3">
        <div class="container">
            <div class="d-flex align-items-center">
                <img src="{{asset('assets/police.png')}}" alt="GB Police Integrity Logo" style="height: 50px;" class="me-3">
                <div>
                    <h1 class="h4 mb-0">GB Police Accountability Portal</h1>
                    <p class="mb-0">Secure Complaint Submission System</p>
                </div>
            </div>
        </div>
    </header>
    ...
    <footer class="integrity-theme py-4 mt-5">
        <div class="container text-center small">
            <div class="row">
                <div class="col-md-4 mb-3">
                    <h4 class="h6">Accountability</h4>
                    <p class="mb-0">Ethics Committee</p>
                    <p class="mb-0">Transparency Reports</p>
                </div>
                <div class="col-md-4 mb-3">
                    <h4 class="h6">Support</h4>
                    <p class="mb-0">Legal Assistance</p>
                    <p class="mb-0">Victim Services</p>
                </div>
                <div class="col-md-4">
                    <h4 class="h6">Follow Up</h4>
                    <p class="mb-0">Case Status Check</p>
                    <p class="mb-0">Feedback Portal</p>
                </div>
            </div>
            <hr class="my-3">
            <p class="mb-0">© 2023 GB Police Accountability Bureau. All complaints treated confidentially.</p>
        </div>
    </footer>
